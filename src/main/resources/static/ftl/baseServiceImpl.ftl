...
import ${servicePackagePath}.BaseService;
import ${serviceImplPackagePath}.BaseServiceImpl;
import ${mapperPackagePath}.BaseMapper;


public class BaseServiceImpl
<T> implements BaseService
    <T> {
        ...
        <T> baseMapper;
            ...
            public void setMapper(BaseMapper
            <T> baseMapper) {
